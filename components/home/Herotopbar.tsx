...
export default function HeroTopBar() {
  return (
    <div className="fixed top-5 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-5xl">
      <nav
        className="flex items-center justify-between px-2 py-2 md:px-4 md:py-2.5 rounded-full backdrop-blur-xl bg-[var(--bg)]/80 shadow-[0_8px_32px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.1)]"
        style={{ border: "1px solid var(--line)" }}
      >
        {/* Brand Logo & Identifier */}
        <Link href="/" className="flex items-center gap-1 md:gap-2.5 pl-1 group">
